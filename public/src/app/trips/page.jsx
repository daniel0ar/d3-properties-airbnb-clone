...
const page = () => {
  ...
  return (
    <div>
      <Navbar></Navbar>
      <div className="p-10">
        <h1 className="text-3xl leading-normal font-semibold text-d3prop-light-black mb-4">Your bookings</h1>
        <p className="leading-normal mb-5">Check the details of your trips before you go!.</p>
