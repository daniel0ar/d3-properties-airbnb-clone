...
const ListingCreated = () => {
  ...
  const resetState = () => {
    ...
    setPlaceSpace(undefined);
    setplaceAmeneties(undefined);
    setPhotos(undefined);
    setTitle(undefined);
  ...
  useEffect(() => {
    if (userInfo && locationType && placeType && mapData && locationData && placeSpace && placeAmeneties && photos && title && description){
      createListingApi({
